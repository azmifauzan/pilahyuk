...
export const BASE_BELT_SPEED_PX_PER_SEC = 150

export const DIFFICULTY_TIERS = Object.freeze([
  Object.freeze({ untilSec: 30, speedMul: 1.0, spawnEverySec: 2.0 }),
  Object.freeze({ untilSec: 60, speedMul: 1.25, spawnEverySec: 1.5 }),
  Object.freeze({ untilSec: 90, speedMul: 1.5, spawnEverySec: 1.2 })
])
